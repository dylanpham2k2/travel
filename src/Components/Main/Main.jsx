...
const Data = [
  {
    ...
    fees: "$700",
    description:
      "The epitome of romance, Bora Bora is one of the best travel Bestinations in the World. This place is known for its luxurious stays and adventurous activities.",
  },
  {
    id: 2,
    imgSrc: img2,
      ...
      <div className="secContent grid">
        {Data.map(
          ({ id, imgSrc, destTitle, location, grade, fees, description }) => {
            return (
              <div className="signleDestination" data-aos="fade-up" key={id}>
